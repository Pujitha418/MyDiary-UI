...
function useApiImageReqParam(url, token, requestParam, defaultValue) {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const res = await common_axios.get(url, {params:requestParam});
      console.log('res-', res);
...
export default useApiImageReqParam;